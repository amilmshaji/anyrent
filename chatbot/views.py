...
def get_response(user_input):
    ...
    if user_input == "hi" or user_input == "hello":
        ...
        response= f'Sure, I can help you navigate to the {user_input} page. Here is the link: <a href="http://127.0.0.1:8000/{ user_input }" target="_blank">http://127.0.0.1:8000/{ user_input }</a>'

    elif "help" in user_input:
        response= "I can help you navigate to different pages on our website. Just tell me which page you'd like to visit, or type 'menu' to see a list of options."
